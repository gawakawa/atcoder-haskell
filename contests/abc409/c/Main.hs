...
equilateralTraiangles :: Int -> [(Int, Int, Int)]
equilateralTraiangles = undefined

existsEquilateralTraiangle :: (Int, Int, Int) -> [Int] -> Bool
existsEquilateralTraiangle equilateralTraiangle nodes = undefined

solve :: Int -> [Int] -> Int
solve l ds = undefined $ do
    equilateralTraiangle <- equilateralTraiangles l
    undefined
  where
    nodesCount :: [IM.IntMap Int]
